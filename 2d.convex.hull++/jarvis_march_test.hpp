/**
 * Unit tests for Jarvis March algorithm.
 */
...
static auto test_jarvis_march_with_negative_x = add_test([] {
    // Arrange
...
static auto test_jarvis_march_general_case = add_test([] {
    // Arrange
...
static auto test_jarvis_march_square_case = add_test([] {
    // Arrange
...
static auto test_jarvis_march_triangle_case = add_test([] {
    // Arrange
    auto points = std::array<point2d, 12>{{
        {0, 0}, {5, -5}, {-5, -5}, {-1, 2},
        {2, 0}, {-2, -1}, {1, 2}, {1, 1},
...
static auto test_jarvis_march_with_empty_set = add_test([] {
    // Arrange
...
static auto test_jarvis_march_with_1_point = add_test([] {
    // Arrange
...
static auto test_jarvis_march_with_2_points = add_test([] {
    // Arrange
...
static auto test_jarvis_march_with_3_points = add_test([] {
    // Arrange
...
static auto test_jarvis_march_collinear_x = add_test([] {
    // Arrange
...
static auto test_jarvis_march_collinear_y = add_test([] {
    // Arrange
    auto points = std::array<point2d, 4>{{
        {1, 1}, {1, -3}, {1, -10}, {1, 10}
    }};
...
static auto test_jarvis_march_collinear = add_test([] {
    // Arrange
    auto points = std::array<point2d, 4>{{
        {23, 23}, {1, 1}, {3, 3}, {-7, -7}
    }};
...
static auto test_jarvis_march_duplicate_origin = add_test([] {
    // Arrange
...
static auto test_jarvis_march_duplicate_points = add_test([] {
    // Arrange
...
static auto test_jarvis_march_more_duplicate_points = add_test([] {
    // Arrange
